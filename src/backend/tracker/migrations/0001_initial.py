    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('birthday', models.DateField(blank=True, help_text='О себе', null=True, verbose_name='О себе')),
                ...
                ('skills', models.ManyToManyField(help_text='Навыки', related_name='resume', to='tracker.skill', verbose_name='Навыки')),
            ],
            options={
                'verbose_name': 'Резюме',
